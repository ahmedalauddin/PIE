...
class EnhancedTable extends React.Component {
  ...
  render() {
    ...
    const emptyRows =
      rowsPerPage - Math.min(rowsPerPage, numRecords - page * rowsPerPage);
    const numRecords = users.length;

    const align = cellDatatype => {
      let alignment = "left";
                ...
                .map(person => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align={row.numeric ? "right" : "left"}>
                        {person.username}
                      </TableCell>
