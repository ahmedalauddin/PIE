  ...
  componentDidMount() {
    ...
    if (projectid > 0) {
      let projectJson = `{
        "id": 118,
        "orgId": 2,
        "title": "Address Increasing Annual Costs",
        "description": "Reduce inventory in all warehouses.  Add more text here.",
        "businessGoal": "Reduce inventory by 20%",
        "summary": null,
        "mindmapId": null,
        "nodeId": null,
        "mainKpiId": 14,
        ...
        "currentTaskId": 24,
        "progress": 10,
        "startAt": "2019-03-15T00:00:00.000Z",
        "endAt": "2019-03-29",
        "createdAt": "2019-03-22T19:20:57.000Z",
        "updatedAt": "2019-05-01T15:00:56.000Z",
        "organization": {
          "id": 2,
          "name": "Northwest Lumber",
          "owningOrg": false,
          "createdAt": "2019-01-27T03:30:44.000Z",
          "updatedAt": "2019-02-24T19:52:04.000Z"
        },
        "mainKpi": {
          "id": 14,
          "title": "Repair time",
          "orgId": 2,
          "deptId": 1,
          "description": "Address problems with diagnosing equipment failure",
      ...
      kpisJson = `
        [ 
          { 
            ...
            "type": "lagging",
            "status": "1",
            "createdAt": "2019-03-22T19:23:13.000Z",
            "updatedAt": "2019-04-17T18:17:53.000Z",
            "organization": {
              "id": 2,
              "name": "Northwest Lumber",
              "owningOrg": false,
            ...
            "project": [
              {
                ...
                "updatedAt": "2019-05-01T15:00:56.000Z",
                "KpiProjects": {
                  "createdAt": "2019-03-22T19:33:30.000Z",
                  "updatedAt": "2019-03-22T19:33:30.000Z",
                  "kpiId": 14,
                  "projectId": 118
                }
              }
          ...
          },
          {
            ...
            "orgId": 2,
            "deptId": 1,
            "description": "Average time between two failure of the same component or target system.",
            "formulaDescription": null,
            "level": 2,
            "type": "lagging",
            "status": "2",
            "createdAt": "2019-03-22T19:23:14.000Z",
            "updatedAt": "2019-04-17T18:23:39.000Z",
            "organization": {
              "id": 2,
              "name": "Northwest Lumber",
              "owningOrg": false,
          ...
          {
            "id": 18,
            "title": "Increase parts availability - Northeast",
            "orgId": 2,
            "deptId": 2,
            "description": "Increase the availability of parts at all locations.",
            "formulaDescription": null,
            "level": 2,
            "type": "leading",
            "status": "1",
            "createdAt": "2019-03-22T19:23:14.000Z",
            "updatedAt": "2019-04-30T00:57:14.000Z",
            "organization": {
              "id": 2,
              "name": "Northwest Lumber",
              "owningOrg": false,
                          ...
                          {stableSort(this.state.kpis, getSorting("asc", "title")).map(kpi => {
                            return (
                              <TableRow
                                ...
                                key={kpi.id}
                              >
                                <TableCell padding="none" width="10%" align="left">
                                  {kpi.id}
                                </TableCell>
                                <TableCell padding="dense" width="30%" align="left">
                                  <Link to={`../kpicard/${kpi.id}`}>
                                    {kpi.title}
                                  </Link>
                                </TableCell>
                                <TableCell padding="dense" width="40%" align="left">
                                  {kpi.description}
                                </TableCell>
